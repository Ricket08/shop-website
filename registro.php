    ...
    if(count($errors) == 0){
        ...
        if($id > 0){
            ...
            if($idUsuario > 0){
                ...
                $asunto = "Activar cuenta Tienda Blacklist Shop";
                $cuerpo = "Estimado $nombres: <br> Para continuar con el proceso de registro es indispensable confirmar su cuenta por medio del siguiente enlace <a href='$url'>Activar cuenta</a>";
                
                    if($mailer->enviarEmail($email,$asunto,$cuerpo)){
                        echo "Se ha enviado el enlace de activación a la dirección de correo electrónico $email";
                        exit;
                    }
                }else{
        ...
        function existeEmail(email){
            ...
            .then(data => {
                ...
                if(data.ok){
                    ...
                    document.getElementById('validaEmail').innerHTML = 'Ya existe un usuario registrado con este correo'
                } else{
